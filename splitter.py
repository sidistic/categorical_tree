...
def find_best_split(X, y, feature_types, criterion='gini'):
    """
    Find the best feature to split on and the best split point/categories.
...
def build_tree(X, y, feature_types, max_depth=None, min_samples_split=2, 
    ...
    # Find best split
    feature_idx, split_info = find_best_split(X, y, feature_types, criterion)
